...
Version  : 6.3.0
Release  : 85
URL      : https://download.kde.org/stable/frameworks/6.3/kauth-6.3.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.3/kauth-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.3/kauth-6.3.0.tar.xz.sig
...
%setup -q -n kauth-6.3.0
cd %{_builddir}/kauth-6.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717776815
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6AuthCore.so.6.3.0
...
/usr/lib64/libKF6AuthCore.so.6.3.0
