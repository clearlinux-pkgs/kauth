...
Version  : 5.110.0
Release  : 70
URL      : https://download.kde.org/stable/frameworks/5.110/kauth-5.110.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.110/kauth-5.110.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.110/kauth-5.110.0.tar.xz.sig
...
%prep
%setup -q -n kauth-5.110.0
cd %{_builddir}/kauth-5.110.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694444126
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5Auth.so.5.110.0
/V3/usr/lib64/libKF5AuthCore.so.5.110.0
...
/usr/lib64/libKF5Auth.so.5.110.0
/usr/lib64/libKF5AuthCore.so.5
/usr/lib64/libKF5AuthCore.so.5.110.0
