...
Version  : 5.109.0
Release  : 69
URL      : https://download.kde.org/stable/frameworks/5.109/kauth-5.109.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.109/kauth-5.109.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.109/kauth-5.109.0.tar.xz.sig
...
%prep
%setup -q -n kauth-5.109.0
cd %{_builddir}/kauth-5.109.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692992772
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5Auth.so.5.109.0
/V3/usr/lib64/libKF5AuthCore.so.5.109.0
...
/usr/lib64/libKF5Auth.so.5.109.0
/usr/lib64/libKF5AuthCore.so.5
/usr/lib64/libKF5AuthCore.so.5.109.0
