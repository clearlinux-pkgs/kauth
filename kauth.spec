...
Source0  : https://download.kde.org/stable/frameworks/5.95/kauth-5.95.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.95/kauth-5.95.0.tar.xz.sig
...
%prep
%setup -q -n kauth-5.95.0
cd %{_builddir}/kauth-5.95.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655138288
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kauth-5.95.0/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kauth/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/kauth-5.95.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kauth/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/kauth-5.95.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kauth/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kauth-5.95.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/kauth/6f1f675aa5f6a2bbaa573b8343044b166be28399
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Auth.so.5.95.0
/usr/lib64/libKF5AuthCore.so.5
/usr/lib64/libKF5AuthCore.so.5.95.0
