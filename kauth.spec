...
Version  : 5.102.0
Release  : 60
URL      : https://download.kde.org/stable/frameworks/5.102/kauth-5.102.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.102/kauth-5.102.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.102/kauth-5.102.0.tar.xz.sig
...
%prep
%setup -q -n kauth-5.102.0
cd %{_builddir}/kauth-5.102.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673893033
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Auth.so.5.102.0
/usr/lib64/libKF5AuthCore.so.5
/usr/lib64/libKF5AuthCore.so.5.102.0
