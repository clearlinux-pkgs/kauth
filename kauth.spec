...
Version  : 6.7.0
Release  : 91
URL      : https://download.kde.org/stable/frameworks/6.7/kauth-6.7.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.7/kauth-6.7.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.7/kauth-6.7.0.tar.xz.sig
...
%setup -q -n kauth-6.7.0
cd %{_builddir}/kauth-6.7.0
pushd ..
cp -a kauth-6.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728751613
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6AuthCore.so.6.7.0
...
/usr/lib64/libKF6AuthCore.so.6.7.0
