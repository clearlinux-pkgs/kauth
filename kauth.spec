...
Version  : 6.0.0
Release  : 77
URL      : https://download.kde.org/stable/frameworks/6.0/kauth-6.0.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.0/kauth-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.0/kauth-6.0.0.tar.xz.sig
...
%prep
%setup -q -n kauth-6.0.0
cd %{_builddir}/kauth-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709226203
mkdir -p clr-build
pushd clr-build
