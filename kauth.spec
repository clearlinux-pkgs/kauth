...
Source0  : https://download.kde.org/stable/frameworks/6.1/kauth-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.1/kauth-6.1.0.tar.xz.sig
...
%setup -q -n kauth-6.1.0
cd %{_builddir}/kauth-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712946451
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6AuthCore.so.6.1.0
...
/usr/lib64/libKF6AuthCore.so.6.1.0
