...
Version  : 6.2.0
Release  : 84
URL      : https://download.kde.org/stable/frameworks/6.2/kauth-6.2.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.2/kauth-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.2/kauth-6.2.0.tar.xz.sig
...
%setup -q -n kauth-6.2.0
cd %{_builddir}/kauth-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715628441
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6AuthCore.so.6.2.0
...
/usr/lib64/libKF6AuthCore.so.6.2.0
